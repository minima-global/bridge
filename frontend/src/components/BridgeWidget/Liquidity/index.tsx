...
const Liquidity = () => {
  ...
  return (
    <div className="mx-4 md:mx-0 text-left">
      ...
      <div>
        <p className="text-sm mb-3">You can choose to provide liquidity to the orderbook for other users to trade with. All  <b>native Minima</b> and <b>USDT</b> in your Swap wallet will be made available for other users. You will make a margin based on your buy/sell prices. Trades will only execute at your chosen buy/sell prices.</p>
        <YourPools />
      </div>
    </div>
  );
