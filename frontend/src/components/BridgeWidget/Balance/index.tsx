...
const Balance = () => {
  ...
  return (
    <div className="mx-4 md:mx-0 text-left">
      ...
      <div>
        {runningLow.minima && <div className="bg-yellow-300 rounded-lg px-3 py-2 my-3"><p className="text-xs font-bold">You are running low on Minima, you should top up to fulfill orders</p></div>}
      </div>
      <div>
      ...
      {runningLow.ethereum && <div className="bg-yellow-300 rounded-lg px-3 py-2 my-3"><p className="text-xs font-bold">You are running low on Ethereum, you should top up to fulfill orders</p></div>}
